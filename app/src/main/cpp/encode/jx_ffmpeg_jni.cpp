...
Java_com_myopengl_zcweicheng_encode_FFmpegBridge_prepareJXFFmpegEncoder(JNIEnv *env,
                                                                                        jclass type,
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_myopengl_zcweicheng_encode_FFmpegBridge_encodeFrame2H264(JNIEnv *env,
                                                                                  jclass type,
                                                                                  jbyteArray data_) {
...
Java_com_myopengl_zcweicheng_encode_FFmpegBridge_getFFmpegConfig(JNIEnv *env,
                                                                                 jclass type) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_myopengl_zcweicheng_encode_FFmpegBridge_encodeFrame2AAC(JNIEnv *env,
                                                                                 jclass type,
                                                                                 jbyteArray data_) {
    jbyte *elements = env->GetByteArrayElements(data_, 0);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_myopengl_zcweicheng_encode_FFmpegBridge_recordEnd(JNIEnv *env,
                                                                           jclass type) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_myopengl_zcweicheng_encode_FFmpegBridge_nativeRelease(JNIEnv *env, jclass type) {
