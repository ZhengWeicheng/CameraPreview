...
Java_com_myopengl_zcweicheng_encode_FFmpegBridge_jxCMDRun(JNIEnv *env, jclass type,
...
Java_com_myopengl_zcweicheng_encode_FFmpegBridge_initJXFFmpeg(JNIEnv *env, jclass type,
                                                                           jboolean debug,
                                                                           jstring logUrl_) {
    JNI_DEBUG = debug;
